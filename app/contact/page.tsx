...
//         <div className="relative mx-auto flex min-h-[62vh] max-w-7xl items-end px-6 py-14 md:py-16">
//           <motion.div
...
//               travel style, preferred destinations, accommodation level, or special
//               requests.
//             </p>
...
//                     Your form was submitted. You can now connect this page to your
//                     backend, email service, or WhatsApp workflow.
//                   </div>
//                 </div>
//               </div>
//             ) : null}
...
//                 <button
//                   type="submit"
//                   className="inline-flex items-center gap-2 rounded-full bg-[#0b2b5b] px-6 py-3 text-sm font-semibold text-white transition hover:opacity-95"
//                 >
//                   Send Inquiry
...
//                   <span
//                     key={tag}
//                     className="rounded-full bg-slate-50 px-3 py-2 text-xs font-semibold text-slate-700 ring-1 ring-slate-200"
//                   >
//                     {tag}
//                   </span>
//                 ))}
...
//                 }
//                 className="mt-7 inline-flex items-center gap-2 rounded-full bg-[#0b2b5b] px-6 py-3 text-sm font-semibold text-white transition hover:opacity-95"
//               >
//                 Request custom tour
...
//               Replace the iframe link below with your exact Google Maps embed link
//               for Prathibha Lanka Voyages.
//             </p>
//           </div>
...
// const inputClass =
//   "w-full rounded-2xl border border-slate-200 bg-white px-4 py-3 text-sm text-slate-900 outline-none transition placeholder:text-slate-400 focus:border-[#0b2b5b] focus:ring-4 focus:ring-[#0b2b5b]/10";
...
//       <div className="grid h-11 w-11 shrink-0 place-items-center rounded-2xl bg-[#0b2b5b] text-white">
//         {icon}
//       </div>
//       <div>
...
//   return (
//     <div className="flex items-start gap-4 rounded-2xl bg-slate-50 p-4 ring-1 ring-slate-200">
//       <div className="min-w-[44px] rounded-2xl bg-[#0b2b5b] px-3 py-2 text-center text-xs font-semibold tracking-[0.18em] text-white">
//         {number}
//       </div>
//       <div>
//         <div className="text-sm font-semibold text-slate-900">{title}</div>
...
export default async function Page({
  ...
  const packageFromUrl = resolved?.package || "";

  return <ContactPageClient packageFromUrl={packageFromUrl} />;
}