...
export default function RealExperiencesSection() {
  ...
  const bgDark = useTransform(scrollYProgress, [0, 1], [0.45, 0.18]);
  ...
  return (
    <section ref={sectionRef} className="relative overflow-hidden" id="reviews">
      ...
      <div className="absolute inset-0" id="reviews">
        ...
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_top_right,rgba(240,171,29,0.16),transparent_26%),radial-gradient(circle_at_top_left,rgba(255,255,255,0.22),transparent_30%),radial-gradient(circle_at_bottom_left,rgba(207,91,138,0.10),transparent_24%)]" />
      </div>
      ...
      <div className="relative mx-auto max-w-6xl px-6 py-16 md:py-24">
        ...
        >
          <div
            className="select-none text-[68px] font-semibold tracking-tight text-white/10 md:text-[130px] lg:text-[160px]"
        ...
        <div className="relative mx-auto mt-14 max-w-4xl text-center md:mt-24">
          <motion.div
            ...
            viewport={{ once: true, amount: 0.35 }}
            transition={slowSpring}
            className="inline-flex rounded-full border border-white/12 bg-white/10 px-4 py-2 text-[11px] font-bold uppercase tracking-[0.18em] text-white/90 backdrop-blur md:text-xs"
          >
            Guest Experiences
          </motion.div>
          ...
          <AnimatePresence mode="wait">
            <motion.div
              ...
              exit={{ opacity: 0, y: -14, filter: "blur(10px)" }}
              transition={{ duration: 0.55, ease: [0.2, 0.8, 0.2, 1] }}
              className="mx-auto mt-10 rounded-[32px] border border-white/12 bg-white/10 px-6 py-8 shadow-[0_24px_80px_rgba(0,0,0,0.18)] backdrop-blur-md md:px-10 md:py-10"
            >
              <div
              ...
              <p className="mx-auto mt-6 max-w-4xl text-base leading-8 text-white/85 md:text-lg">
                {active.text}
              </p>

              <div className="mt-8 text-base font-semibold text-[#f7d27a]">
                {active.author}
              </div>
            </motion.div>
          </AnimatePresence>
        ...
        <div className="pointer-events-none absolute inset-x-0 top-1/2 hidden -translate-y-1/2 md:block">
          <div className="relative mx-auto max-w-6xl">
            <button
              onClick={prev}
              className="pointer-events-auto absolute left-0 grid h-12 w-12 place-items-center rounded-full border border-white/15 bg-white/80 text-[#17352a] shadow-[0_10px_30px_rgba(0,0,0,0.12)] backdrop-blur transition hover:bg-white"
              aria-label="Previous testimonial"
            >
              <ChevronLeft className="h-5 w-5" />
            </button>
            ...
            <button
              onClick={next}
              className="pointer-events-auto absolute right-0 grid h-12 w-12 place-items-center rounded-full border border-white/15 bg-white/80 text-[#17352a] shadow-[0_10px_30px_rgba(0,0,0,0.12)] backdrop-blur transition hover:bg-white"
              aria-label="Next testimonial"
            >
              <ChevronRight className="h-5 w-5" />
            </button>
        ...
        <div className="mt-10 flex items-center justify-center gap-3 md:hidden">
          <button
            onClick={prev}
            className="grid h-11 w-11 place-items-center rounded-full border border-white/15 bg-white/80 text-[#17352a] backdrop-blur"
            aria-label="Previous"
          >
            <ChevronLeft className="h-5 w-5" />
          </button>
