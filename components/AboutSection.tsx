...
//   return (
//     <section className="bg-gray-200 py-16 mt-6">
...
export default function AboutSection() {
  ...
  return (
    <section className="bg-gray-200 py-8 mt-4">
      <div className="w-full max-w-6xl mx-auto px-4 md:px-6">
        <div className="about-card rounded-2xl flex flex-col md:flex-row gap-4 md:gap-6 items-stretch">
          
          {/* LEFT */}
          <div className="flex-1 flex flex-col justify-between about-left p-4 md:p-6">
            <div className="space-y-1.5 md:space-y-2">
              <h2 className="text-[10px] md:text-xs uppercase tracking-[0.15em] text-gray-500">
                About Hello Travels
              </h2>
            ...
            <div className="mt-4 inline-flex items-center bg-black text-white rounded-xl px-4 py-2 ready-box">
          ...
          {/* MIDDLE IMAGE */}
          <div className="flex-shrink-0 flex items-center justify-center about-center p-2">
            <div className="w-36 h-36 md:w-44 md:h-44 rounded-2xl overflow-hidden shadow-lg about-center-image">
              <Image
                src="/about/train-view.jpg"
                alt="Sri Lanka train journey"
                width={400}
          ...
          {/* RIGHT */}
          <div className="flex-1 flex flex-col justify-between about-right p-4 md:p-6">
            <div className="w-full h-32 md:h-40 rounded-2xl overflow-hidden shadow-md mb-3 about-right-image">
              <Image
                src="/about/mountain-view.jpg"
                alt="Sri Lanka landscape"
                width={500}
            ...
            <div className="space-y-1.5 md:space-y-2">
              <p className="text-[10px] md:text-xs uppercase tracking-[0.15em] text-gray-500">
                Travel Experience
              </p>
